		...
		<div className="about">
			...
			<div className="about_right">
				...
				<p className="about_content">
					...
					through user-centric design. <br />I enjoy building everything from
					small business sites to rich interactive web applications. If you are
					a business seeking a web presence or an employer looking to hire, you
				...
				<div className="about_cert">
					...
					<div className="cert_texts">
						...
						<p className="cert_desc">
							Certificate awarded for participating in AWS Machine Learning Foundations Course in AWS Machine Learning Scholarship.
						</p>
					</div>
				</div>
			</div>
